...
from canvasPR_app.views import lti_launch

@patch.multiple('canvasPR_app.views', render=DEFAULT)
class BasicLTIAppViewsTests(unittest.TestCase):
    ...
    @patch('canvasPR_app.views.redirect')
    def test_get_lti_param(self, mock_redirect, render):
        ...
        mock_redirect.assert_called_with('canvasPR_app:main')
